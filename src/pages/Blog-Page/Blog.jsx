...
import mainBlogImg3 from '../../assets/images/blog-img/blog-standard-img-3.jpg'
...
import coffeVideo from '../../assets/video/mixkit-software-developer-working-while-drinks-coffee-1730-medium.mp4'
        ...
        <div className='blog-page'>
            <div className='row'>
              ...
              <div className='col-12 col-md-9'>
                  ...
                  cardTitle='WHAT STANDS IN THE WAY BECOMES THE WAY'
                  pplName='LEWIS HOWES'
                  cardJob='Artists, Lectures'
                  />

                  <MainBlogCard
                    mediaSource={mainBlogImg3}
                    mainBlogTitle='ELEVATE YOUR EXPECTATIONS'
                    mainBlogDesc='by Jane Doe / Enjoyment /30.01.2023'
                    mainBlogText='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean feugiat dictum lacus, ut hendrerit mi pulvinar vel. Fusce id nibh at neque eleifend tristique at sit amet libero. In aliquam in nisl nec sollicitudin. Sed consectetur volutpat sem vitae facilisis. Fusce tristique, magna ornare facilisis sagittis, tortor mi auctor libero, non pharetra sem ex eu felis. Aenean egestas ut purus nec vehicula. Morbi eu nisi erat. Nam mattis id lectus sit amet mattis. Suspendisse eget tristique neque...'
                    mainBlogJob='Features'
                    />
              ...
              <div className='col-12 col-md-3 ps-md-2 ps-lg-5'>
        ...
        <div className='blog-bottom'>
              <div className=' justify-content-between  d-flex'>
                  <div className='align-items-start '>
                    <NavLink to='/blog'><FaArrowLeft className='blog-bottom__icons' size={20}/></NavLink>
                    
                  </div>

                  {/* <div className='align-items-center blog-bottom__nums '>
                    <NavLink to='/blog'>
                      <span className='blog-bottom__num'>1</span>
                      
                    </NavLink>
                    <NavLink to='/blog2'>
                      <span className='blog-bottom__num'>2</span>
